...
type listenerPolicies struct {
	*gentype.ClientWithList[*apiv1alpha1.ListenerPolicy, *apiv1alpha1.ListenerPolicyList]
}
...
func newListenerPolicies(c *GatewayV1alpha1Client, namespace string) *listenerPolicies {
	return &listenerPolicies{
		gentype.NewClientWithList[*apiv1alpha1.ListenerPolicy, *apiv1alpha1.ListenerPolicyList](
			"listenerpolicies",
			c.RESTClient(),
