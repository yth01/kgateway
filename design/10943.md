...
- [Translation unit tests](https://github.com/kgateway-dev/kgateway/blob/ec3f9909932254b374049c5284762f958c634f80/pkg/kgateway/translator/gateway/gateway_translator_test.go#L398), which assert that given some input (Gateways, HTTPRoutes, Services) we get the correct translated output (i.e. Envoy config)
