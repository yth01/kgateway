...
The AWS Lambda plugin will be implemented in the `pkg/kgateway/extensions2/plugins/upstream` directory. At a high-level, the following changes will be made:
