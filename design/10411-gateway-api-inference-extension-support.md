...
Add GIE ESE as a supported [plugin](https://github.com/kgateway-dev/kgateway/tree/main/pkg/kgateway/extensions2/plugins). The plugin will:
...
Since GIE extensions are decoupled from the Gateway implementation, a separate [deployer](https://github.com/kgateway-dev/kgateway/tree/main/pkg/kgateway/deployer)
...
* Update the [translator](https://github.com/kgateway-dev/kgateway/tree/main/pkg/kgateway/translator) package to handle InferencePool references from the HTTPRoute type.
